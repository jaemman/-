...
<body>
	<h3>회원 가입</h3>
	<form action="chapter06/form06_process.jsp" name="member" method="post">
		...
		</select>-<input type=text" mexlength="4" size="4" name="phone2">-<input type=text" mexlength="4" size="4" name="phone3">
